<head>
        ...
        <!-- Tell the browser to be responsive to screen width -->
                            ...
                            <link rel="stylesheet" href="/bundles/sonataadmin/vendor/admin-lte/dist/css/skins/skin-blue.css">
...
<div id="sfwdt20c029" class="sf-toolbar sf-display-none" data-sfurl="/_wdt/20c029" style="display: block;"><!-- START of Symfony Web Debug Toolbar -->
<div id="sfMiniToolbar-20c029" class="sf-minitoolbar" data-no-turbolink="" style="display: none;">
    <a href="#" title="Show Symfony toolbar" tabindex="-1" id="sfToolbarMiniToggler-20c029" accesskey="D">
...
<div id="sfToolbarClearer-20c029" class="sf-toolbar-clearer" style="display: block;"></div>

<div id="sfToolbarMainContent-20c029" class="sf-toolbarreset clear-fix" data-no-turbolink="" style="display: block;">
    ...
    <a href="http://mapas.militantesmasipsp.com/_profiler/20c029?panel=request">        <div class="sf-toolbar-icon">        <span class="sf-toolbar-status sf-toolbar-status-green">200</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="#aaa" d="M23 7.8L14 .4a1.3 1.3 0 0 0-2 .9V4a13.6 13.6 0 0 1-2.2.6l-1.3.5c-.5.1-1 .4-1.4.6l-.7.4-.7.4a10.6 10.6 0 0 0-1.4 1A13.2 13.2 0 0 0 3 8.8a15.3 15.3 0 0 0-1.1 1.5 17.6 17.6 0 0 0-.9 1.6l-.5 1.7c-.2.5 0 1.2 0 1.7a10.2 10.2 0 0 0 0 1.5A5.7 5.7 0 0 0 1 18l.4 1.2 1 2 1 1.4 1 1c.2.2.4.1.3-.2l-.3-1.2-.3-1.6-.1-1.9v-1a3.4 3.4 0 0 1 .2-1 6.4 6.4 0 0 1 .3-.8l.4-.8.6-.6.6-.6.7-.4a7.5 7.5 0 0 1 .8-.2 4.5 4.5 0 0 1 .8-.2h2.5a3.8 3.8 0 0 1 1.2.3v3.1a1.3 1.3 0 0 0 2 1l9-7.5a1.5 1.5 0 0 0 0-2.3z"></path></svg>
        ...
        <div class="sf-toolbar-info-group">
                <div class="sf-toolbar-info-piece">
                    <b>
                        <span class="sf-toolbar-redirection-status sf-toolbar-status-yellow">302</span>
                        Redirect from
                    </b>
                    <span>
                                        <span>sonata_user_admin_security_check</span>

                        (<a href="/_profiler/2de020">2de020</a>)
                    </span>
                </div>
            </div>
    ...
    <div class="sf-toolbar-block sf-toolbar-block-ajax sf-toolbar-status-normal" style="display: block;">
        ...
        <span class="sf-toolbar-value sf-toolbar-ajax-request-counter">8</span>
    </div>
            <div class="sf-toolbar-info">        <div class="sf-toolbar-info-piece">
            <b class="sf-toolbar-ajax-info">8 AJAX requests</b>
        </div>
        <div class="sf-toolbar-info-piece">
            <table class="sf-toolbar-ajax-requests">
                ...
                <tbody class="sf-toolbar-ajax-request-list"><tr class="sf-ajax-request sf-ajax-request-ok"><td><a href="http://mapas.militantesmasipsp.com/_profiler/4f9bb8">4f9bb8</a></td><td>GET</td><td>xhr</td><td><span class="sf-toolbar-status">200</span></td><td class="sf-ajax-request-url" title="/admin/JSON/Recinto/0/2005"><a href="/admin/JSON/Recinto/0/2005">/admin/JSON/Recinto/0/2005</a></td><td class="sf-ajax-request-duration">2346ms</td></tr><tr class="sf-ajax-request sf-ajax-request-ok"><td><a href="http://mapas.militantesmasipsp.com/_profiler/127c2b">127c2b</a></td><td>GET</td><td>xhr</td><td><span class="sf-toolbar-status">200</span></td><td class="sf-ajax-request-url" title="/admin/JSON/Recinto/0/2005"><a href="/admin/JSON/Recinto/0/2005">/admin/JSON/Recinto/0/2005</a></td><td class="sf-ajax-request-duration">2672ms</td></tr><tr class="sf-ajax-request sf-ajax-request-ok"><td><a href="http://mapas.militantesmasipsp.com/_profiler/cbb6b2">cbb6b2</a></td><td>GET</td><td>xhr</td><td><span class="sf-toolbar-status">200</span></td><td class="sf-ajax-request-url" title="/admin/JSON/Zona/0/2005"><a href="/admin/JSON/Zona/0/2005">/admin/JSON/Zona/0/2005</a></td><td class="sf-ajax-request-duration">2893ms</td></tr><tr class="sf-ajax-request sf-ajax-request-ok"><td><a href="http://mapas.militantesmasipsp.com/_profiler/343898">343898</a></td><td>GET</td><td>xhr</td><td><span class="sf-toolbar-status">200</span></td><td class="sf-ajax-request-url" title="/admin/JSON/Distrito/0/2005"><a href="/admin/JSON/Distrito/0/2005">/admin/JSON/Distrito/0/2005</a></td><td class="sf-ajax-request-duration">2623ms</td></tr><tr class="sf-ajax-request sf-ajax-request-ok"><td><a href="http://mapas.militantesmasipsp.com/_profiler/7352e6">7352e6</a></td><td>GET</td><td>xhr</td><td><span class="sf-toolbar-status">200</span></td><td class="sf-ajax-request-url" title="/admin/JSON/tabla/Recinto/906/2005"><a href="/admin/JSON/tabla/Recinto/906/2005">/admin/JSON/tabla/Recinto/906/2005</a></td><td class="sf-ajax-request-duration">432ms</td></tr><tr class="sf-ajax-request sf-ajax-request-ok"><td><a href="http://mapas.militantesmasipsp.com/_profiler/43e6f6">43e6f6</a></td><td>GET</td><td>xhr</td><td><span class="sf-toolbar-status">200</span></td><td class="sf-ajax-request-url" title="/admin/JSON/tabla/Recinto/1401/2005"><a href="/admin/JSON/tabla/Recinto/1401/2005">/admin/JSON/tabla/Recinto/1401/2005</a></td><td class="sf-ajax-request-duration">772ms</td></tr><tr class="sf-ajax-request sf-ajax-request-ok"><td><a href="http://mapas.militantesmasipsp.com/_profiler/c29acf">c29acf</a></td><td>GET</td><td>xhr</td><td><span class="sf-toolbar-status">200</span></td><td class="sf-ajax-request-url" title="/admin/JSON/tabla/Recinto/1401/2005"><a href="/admin/JSON/tabla/Recinto/1401/2005">/admin/JSON/tabla/Recinto/1401/2005</a></td><td class="sf-ajax-request-duration">636ms</td></tr><tr class="sf-ajax-request sf-ajax-request-ok"><td><a href="http://mapas.militantesmasipsp.com/_profiler/18f804">18f804</a></td><td>GET</td><td>xhr</td><td><span class="sf-toolbar-status">200</span></td><td class="sf-ajax-request-url" title="/admin/JSON/tabla/Recinto/2113/2005"><a href="/admin/JSON/tabla/Recinto/2113/2005">/admin/JSON/tabla/Recinto/2113/2005</a></td><td class="sf-ajax-request-duration">2599ms</td></tr></tbody>
            </table>
        </div>
    </div>
</div>
    ...
    <a href="http://mapas.militantesmasipsp.com/_profiler/20c029?panel=cache">        <div class="sf-toolbar-icon">            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="#AAA" d="M2.3 6l9-4.6a1.5 1.5 0 0 1 1.4 0l9 4.7a1.5 1.5 0 0 1 0 2.6l-9 4.7a1.5 1.5 0 0 1-1.4 0l-9-4.7a1.5 1.5 0 0 1 0-2.6zm18.3 5L12 15.4 3.4 11a1.4 1.4 0 0 0-1.2 2.4l9.2 4.8a1.4 1.4 0 0 0 1.2 0l9.2-4.8a1.4 1.4 0 0 0-1.3-2.4zm0 4.5L12 19.9l-8.6-4.4a1.4 1.4 0 0 0-1.2 2.4l9.2 4.7a1.4 1.4 0 0 0 1.2 0l9.2-4.7a1.4 1.4 0 0 0-1.3-2.5z"></path></svg>
            ...
            <span class="sf-toolbar-info-piece-additional-detail">
                ...
                <span class="sf-toolbar-value">0.18</span>
                <span class="sf-toolbar-label">ms</span>
            </span>
        </div>
    </a>        <div class="sf-toolbar-info">        <div class="sf-toolbar-info-piece">
    ...
    <a href="http://mapas.militantesmasipsp.com/_profiler/20c029?panel=db">        <div class="sf-toolbar-icon">
    ...
    c-0.8,0-1.5-0.7-1.5-1.5s0.7-1.5,1.5-1.5s1.5,0.7,1.5,1.5S18.8,13.6,18,13.6z M19,16H5c-1.7,0-3,1.3-3,3s1.3,3,3,3h14c1.7,0,3-1.3,3-3S20.7,16,19,16z M18,20.6c-0.8,0-1.5-0.7-1.5-1.5s0.7-1.5,1.5-1.5s1.5,0.7,1.5,1.5S18.8,20.6,18,20.6z"></path>
                    ...
                    <span class="sf-toolbar-info-piece-additional-detail">
                        <span class="sf-toolbar-label">in</span>
                        <span class="sf-toolbar-value">1.70</span>
                        <span class="sf-toolbar-label">ms</span>
                    </span>
        ...
        <a href="/_profiler/20c029?panel=block">
    ...
    <a href="http://mapas.militantesmasipsp.com/_profiler/20c029?panel=config">        <div class="sf-toolbar-icon">        <span class="sf-toolbar-label">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="#AAA" d="M12 .9C5.8.9.9 5.8.9 12a11 11 0 1 0 22.2 0A11 11 0 0 0 12 .9zm6.5 6c-.6 0-.9-.3-.9-.8 0-.2 0-.4.2-.6l.2-.4c0-.3-.5-.4-.6-.4-1.8.1-2.3 2.5-2.7 4.4l-.2 1c1 .2 1.8 0 2.2-.3.6-.4-.2-.7-.1-1.2.1-.3.5-.5.7-.6.5 0 .7.5.7.9 0 .7-1 1.8-3 1.8l-.6-.1-.6 2.4c-.4 1.6-.8 3.8-2.4 5.7-1.4 1.7-2.9 1.9-3.5 1.9-1.2 0-1.9-.6-2-1.5 0-.8.7-1.3 1.2-1.3.6 0 1.1.5 1.1 1s-.2.6-.4.6c-.1.1-.3.2-.3.4 0 .1.1.3.4.3.5 0 .8-.3 1.1-.5 1.2-.9 1.6-2.7 2.2-5.7l.1-.7.7-3.2c-.8-.6-1.3-1.4-2.4-1.7-.6-.1-1.1.1-1.5.5-.4.5-.2 1.1.2 1.5l.7.6c.7.8 1.2 1.6 1 2.5-.3 1.5-2 2.6-4 1.9-1.8-.6-2-1.8-1.8-2.5.2-.6.6-.7 1.1-.6.5.2.6.7.6 1.2l-.1.3c-.2.1-.3.3-.3.4-.1.4.4.6.7.7.7.3 1.6-.2 1.8-.8a1 1 0 0 0-.4-1.1l-.7-.8c-.4-.4-1.1-1.4-.7-2.6.1-.5.4-.9.7-1.3a4 4 0 0 1 2.8-.6c1.2.4 1.8 1.1 2.6 1.8.5-1.2 1-2.4 1.8-3.5.9-.9 1.9-1.6 3.1-1.7 1.3.2 2.2.7 2.2 1.6 0 .4-.2 1.1-.9 1.1z"></path></svg>
        ...
        <span class="sf-toolbar-value">4.2.9</span>
            ...
            <div class="sf-toolbar-info-piece">
                <b>Profiler token</b>
                <span>
                                            <a href="http://mapas.militantesmasipsp.com/_profiler/20c029">20c029</a>
                                    </span>
            </div>
